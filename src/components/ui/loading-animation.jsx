...
export function LoadingAnimation() {
  ...
  return (
    <div className="fixed inset-0 bg-background/80 backdrop-blur-sm z-50 flex items-center justify-center">
      <div className="flex flex-col items-center justify-center gap-8 p-6 max-w-md w-full">
        {/* Progress Steps */}
        <div className="w-full space-y-4 bg-card p-6 rounded-xl shadow-lg border">
